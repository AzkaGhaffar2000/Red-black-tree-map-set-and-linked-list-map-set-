...
public class DNA {
	...
	public static void getPosition(StringBuffer nString,  MyListMap<String, String> theMap) {
	...
	public static void printResult(MyListMap<String, MyListSet<Integer>> theMap2, String printing) {
